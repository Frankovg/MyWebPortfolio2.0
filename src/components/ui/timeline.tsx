    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs md:w-full lg:max-w-xs" >
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-darkPrimary flex items-center justify-center">
