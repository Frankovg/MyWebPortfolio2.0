...
export function LetsConnectLink() {
  return (
    <li className="max-600:hidden">
      <Link
        href="/contact"
        className="group relative rounded-sm border border-solid border-whiteText text-lg font-semibold py-4.5 px-8.5 transition duration-300 ease-in hover:border-background overflow-hidden"
      >
