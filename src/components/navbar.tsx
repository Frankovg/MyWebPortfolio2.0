...
function NavLink({ href, className, children }: NavLinkProps) {
  ...
  const linkClassName = cn("text-lg hover:text-white transition-colors duration-300 ease-in-out", className)
  return (
    <li>
...
export default function Navbar({ session }: NavbarProps) {
  ...
  return (
    <>
      <nav className={cn("fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ease-in-out", scrolled ? "bg-background py-5" : "bg-transparent py-8")}>
