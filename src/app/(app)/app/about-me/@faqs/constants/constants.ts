...
export const INSPIRATION = [
  "Since a young age, computers have been my passion, though for a long time, I never imagined they could become my career.",
  "I have an innate curiosity, especially for understanding how things work. This curiosity led me to study Industrial Design, a field that answered many of my questions and sparked new ones.",
  "Today, I’m thrilled to be a developer because constant learning is what keeps me motivated, and the excitement of facing new challenges and exploring emerging technologies fuels my passion. Curiosity remains, as always, my greatest inspiration."
]
...
export const HOBBIES = [
  {
    ...
    name: 'Gaming',
    icon: VideoGames,
    description: "I'm a die-hard PC gamer, and I don't see that changing anytime soon! Whether I'm teaming up with friends in online games or getting lost in open-world adventures with epic stories, gaming is my jam. I'm all about competitive shooters, RPGs, exciting adventures, and immersive simulators – they're my go-to genres!."
  },
  {
    id: 2,
    name: 'Sports',
    icon: Sport,
    description: "I'm all about skateboarding and mountain biking – they're my top picks when it comes to sports. But honestly, I'm a fan of pretty much any extreme sport out there. The mix of adrenaline, speed, and the whole culture around these sports just gets me hooked!."
  },
  {
    id: 3,
    name: 'Outdoor',
    icon: Outdoor,
    description: "My ideal getaways? Camping out in the middle of nowhere. I'm a nature enthusiast who thrives on soaking up stunning landscapes. Weekends are all about venturing to mountains, hills, forests, or offbeat beaches with my partner."
  },
  {
    id: 4,
    name: 'Rock Music',
  ...
  },
  {
    ...
    name: 'Airsoft',
    icon: Airsoft,
    description: "Airsoft, my beloved pastime (or rather, a cherished hobby). It's an exhilarating fusion of teamwork, agility, adrenaline, and the great outdoors. Stepping onto the field transports me into a world of camaraderie, where collaborating with fellow enthusiasts to achieve objectives becomes a captivating adventure."
  },
  {
    id: 6,
    name: 'Computer Science',
    icon: Computer,
    description: "What truly excites me are custom-built computers. Keeping abreast of the latest technological advancements and PC components, I'm always hands-on in crafting my setups from scratch."
  },
]