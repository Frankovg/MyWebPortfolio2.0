...
import { COMPANY_CLIENTS } from "@/lib/constants";
        ...
        <HoverCard key={brand.value} openDelay={200} closeDelay={150}>
          <HoverCardTrigger asChild>
            <Button variant={"ghost"} className="flex justify-center h-auto cursor-default p-2.5">
              <brand.icon className='object-contain transition-all duration-300 ease-in-out hover:fill-primary hover:scale-105' />
            </Button>
          </HoverCardTrigger>
