export const GRAPHIC_AND_UX_UI_DESIGN_SEED = {
    ...
    create: [
      {
        ...
        description: `I developed high-impact visual campaigns for major brands across diverse outdoor media formats. 
          ...
          My role involved translating brand messaging into visually striking designs optimized for outdoor viewing conditions, considering factors like viewing distance, lighting conditions, and brief exposure times. 
          ...
          create: [
            {
              ...
              description: `Large-format billboard design for Via Célere real estate development featuring new residential properties. 
                ...
                Created for high-traffic outdoor placement, optimized for maximum visibility and impact from vehicle traffic.
              `,
            },
            {
              imageUrl:
              ...
              description: `Commercial vehicle vinyl wrap design for micasamovil.es, a company specializing in factory-built prefabricated homes. 
                ...
                Applied to company delivery van for mobile advertising and brand visibility while traveling to client locations and construction sites.
              `,
            },
            {
              imageUrl:
              ...
              description: `Commercial storefront design for Admiral Entertainment, a German gaming company with multiple locations across Spain. 
                ...
                Features the distinctive yellow and blue Admiral corporate colors with modern lighting effects to attract customers and establish strong street presence.
              `,
            },
            {
              imageUrl:
        ...
        company: "Pubext 2000, Imaginall and freelance",
        client: "Admiral, El Águila, Amstel, and others",
        techStack: {
          connect: [
            {
              value: "ps",
      ...
      {
        title: "Art design",
        shortDescription: "Original graphic art pieces and creative illustrations.",
        description: `I create original graphic art pieces that blend artistic expression with design principles. 
          These works showcase my creative approach to visual storytelling, exploring different styles, techniques, and conceptual themes through digital illustration and graphic composition. 
          My art design projects demonstrate experimentation with color, form, and visual narrative, often incorporating elements of contemporary design trends while maintaining a personal artistic voice. 
      ...
      {
        title: "Identity Manuals, Instructions and Books",
        shortDescription: "Comprehensive brand guideline documents that establish visual identity standards, including logo usage, color palettes, typography, and design principles for consistent brand application.",
        description: `I specialize in creating comprehensive brand identity manuals and instructional documents that serve as the foundation for consistent brand application across all touchpoints. 
          These detailed guideline documents establish clear visual identity standards, covering logo usage specifications, color palette definitions, typography guidelines, and design principles that ensure brand consistency. 
          My approach involves thorough research and analysis of brand values to create practical, user-friendly manuals that teams can easily follow and implement. 
          I develop clear instructions for various applications including digital platforms, print materials, packaging, and promotional items, ensuring the brand maintains its integrity across all media. 
