      ...
      },
      {
        ...
        gallery: {
          create: [
            {
              imageUrl:
                "https://drive.google.com/uc?export=view&id=1FZCNc-ZeGZxA5aJly_PSICN8_7oKfVSH",
              alt: "Franco Amoroso's old portfolio website homepage.",
              description: "The homepage showcases a clean, modern design built with React. The interface demonstrates his evolution as a front-end developer, industrial designer and graphic designer. The design emphasizes component-based architecture and responsive web design principles.",
            },
            {
              imageUrl: "https://drive.google.com/uc?export=view&id=1XvMrOsodGOi4LQFVaT-t3S9ozkGC6UC8",
              alt: "Franco Amoroso's old portfolio website at the tech stack section.",
              description: "The tech stack section features a comprehensive grid layout showcasing Franco's technical expertise across multiple development domains. The interface design emphasizes visual hierarchy through consistent spacing, typography scaling, and color-coded categorization. Interactive elements include hover states and smooth transitions that enhance user engagement while maintaining accessibility standards. The section demonstrates both technical proficiency and design sensibility through its clean, professional presentation and intuitive information architecture.",
            },
            {
              imageUrl:
                "https://drive.google.com/uc?export=view&id=1Zq8P4rNpUivdMDlwizW6y7c_eK3EdAom",
              alt: "Franco Amoroso's old portfolio website projects section.",
              description: "The projects section showcases a carefully curated collection of Franco's work through an intuitive card-based layout system. Each project card implements a sophisticated information hierarchy using typography scaling, strategic white space, and visual contrast to guide user attention. Interactive hover states provide subtle visual feedback with smooth CSS transitions, while progressive disclosure techniques allow users to access detailed project information without overwhelming the initial presentation. The section incorporates accessibility best practices including proper semantic markup, keyboard navigation support, and ARIA labels for screen reader compatibility.",
            },
            {
              imageUrl:
                "https://drive.google.com/uc?export=view&id=1evFCfFndwAzE82_YmX363ZrgK7074zGC",
              alt: "Franco Amoroso's old portfolio website contact section.",
              description: "The contact form utilizes progressive enhancement with client-side validation, real-time field feedback, and accessible error messaging.",
            },
          ],
        },
